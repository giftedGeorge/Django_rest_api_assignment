...
from inventory_api.views import List_Computer, Create_Computer, Edit_Computer, List_Mouse, Create_Mouse, Edit_Mouse, List_Keyboards, Create_Keyboard, Edit_Keyboard
